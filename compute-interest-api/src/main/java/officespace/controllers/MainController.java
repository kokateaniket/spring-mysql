...
public class MainController {
  ...
  public String insertAccount() {
	  ...
	  accountDao.save(account);
	  System.out.println("account created: id=" + account.getId() + ", balance=" + account.getBalance());
	  return "Success: id=" + account.getId() + ", balance=" + account.getBalance();
  }
